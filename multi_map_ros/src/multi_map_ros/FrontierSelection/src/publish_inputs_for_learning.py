...
class publish_inputs_for_learning:
    ...
    def fringe_callback(self, msg):
        ...
        if self.resized_map_set:
            ...
            fringe_arr = np.full((self.desired_dimension, self.desired_dimension), -1)
            ...
            fringe_map_info.height = self.desired_dimension
            fringe_map_info.width = self.desired_dimension
    ...
    def odom_callback(self, msg):
        ...
        if self.resized_map_set:
            ...
            odom_arr = np.full((self.desired_dimension, self.desired_dimension), -1)
            ...
            odom_map_info.height = self.desired_dimension
            odom_map_info.width = self.desired_dimension
