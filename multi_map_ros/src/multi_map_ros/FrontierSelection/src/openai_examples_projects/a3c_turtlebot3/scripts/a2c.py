...
def main():
    ...
    actor_checkpoint_path = "/home/taylor/multidrone_slam/src/Frontier_ML/openai_examples_projects/a3c_turtlebot3/training_actor/actor_cp.ckpt"
    critic_checkpoint_path = "/home/taylor/multidrone_slam/src/Frontier_ML/openai_examples_projects/a3c_turtlebot3/training_critic/critic_cp.ckpt"
    ...
    for episode in range(train_episodes):
        ...
        while not done:
            ...
            if is_default:
                ...
                observation = np.array(env.env.env._get_obs())
