...
DEFAULT_NET_SIM_CONFIG = "/root/catkin_ws/src/coms/ros-net-sim/example/cfg/experiment.yaml"
DEFAULT_NET_SIM_LAUNCH_FILE = "/root/catkin_ws/src/coms/ros-net-sim/example/launch/experiment.launch"
LAUNCH_CONFIG_LOCAL_IPS = ["192.168.0.1", "192.168.0.2", "192.168.0.3", "192.168.0.4", "192.168.0.5"]
...
def gen_robots(maps: List[np.ndarray]) -> dict:
    ...
    for idx, ip in  enumerate(LAUNCH_CONFIG_LOCAL_IPS):
        ns = "/" + ROBOT_NAMES[idx] + "/"
        s = Sim(address = ip, net_sim_launch_file=DEFAULT_NET_SIM_LAUNCH_FILE, net_config="experiment.yaml", namespace=ns, local_map=maps[idx])
